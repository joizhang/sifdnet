...
class SIFDNet_3(nn.Module):
    ...
    def forward(self, inputs):
        ...
        masks_pred = self.decoder(dcm_feat, features[-2], features[2], features[0])

        return x, masks_pred


def sifdnet_3(num_classes=2, map_classes=1, drop_rate=0., pretrained=False):
    """ ALAM + DCM """
    model = SIFDNet_3(num_classes=num_classes, map_classes=map_classes, drop_rate=drop_rate, pretrained=pretrained)
